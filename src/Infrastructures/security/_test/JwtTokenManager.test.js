...
describe('JwtTokenManager', () => {
  ...
  describe('getTokenByHeaders function', () => {
    it('should return token and replace authorization token type', async () => {
      // Arrange
      const jwtTokenManager = new JwtTokenManager(Jwt.token);
      const authorization = 'Bearer token-123';

      // Action
      const accessToken = await jwtTokenManager.getTokenByHeaders(authorization);
